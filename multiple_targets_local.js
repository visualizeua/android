...
{
		var imgLogo = new AR.ImageResource("assets/common/visualize.com.png");
		...
		var imgTeamPic = new AR.ImageResource("assets/common/teamPic.JPG");
        ...
        //LSSL STUFF
{
        var LSSLVideo = new AR.VideoDrawable("assets/LSSL/LSSLgreenscreen.mp4", 0.95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
		...
		var playButtonImgLSSL = new AR.ImageResource("assets/LSSL/LSSLvidStill.png");
        ...
        //ECL STUFF
{
        var ECLVideo = new AR.VideoDrawable("assets/ECL/ECLgreenscreen.mp4", .95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
		...
		var playButtonImgECL = new AR.ImageResource("assets/ECL/ECLvidStill.png");
        ...
        //MFF STUFF
{
        var MFFVideo = new AR.VideoDrawable("assets/MFF/MFFgreenscreen.mp4", 0.95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
		...
		var playButtonImgMFF = new AR.ImageResource("assets/MFF/MFFvidStill.png");
...
{
        var LSWindTunnelVideo = new AR.VideoDrawable("assets/LSWindTunnel/lowSpeedgreenscreen.mp4", 0.95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
		...
		var playButtonImgLSWindTunnel = new AR.ImageResource("assets/LSWindTunnel/LSvidStill.png");
        ...
        //theCube STUFF
{
        var CubeVideo = new AR.VideoDrawable("assets/theCube/Cubegreenscreen.mp4", .95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
		...
		var playButtonImgCube = new AR.ImageResource("assets/theCube/CubevidStill.png");
        ...
        //Fenrir STUFF
{
        var FenrirVideo = new AR.VideoDrawable("assets/Fenrir/Fenrirgreenscreen.mp4", 0.95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
        ...
        //SPOT STUFF
{
        var SPOTVideo = new AR.VideoDrawable("assets/SPOT/SPOTgreenscreen.mp4", .95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
		...
		var playButtonImgSPOT = new AR.ImageResource("assets/SPOT/SPOTvidStill.png");
        ...
        //Astrobotics STUFF
{
		...
		var playButtonImgAstrobotics = new AR.ImageResource("assets/Astrobotics/AstroboticsvidStill.png");
        ...
        //Firefly STUFF
{
        var FireflyVideo = new AR.VideoDrawable("assets/Firefly/Fireflygreenscreen.mp4", .95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
        ...
        //BamaRacing STUFF
{
        var BamaRacingVideo = new AR.VideoDrawable("assets/BamaRacing/BamaRacinggreenscreen.mp4", .95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
        ...
        //CrimsonRacing STUFF
{
        var CrimsonRacingVideo = new AR.VideoDrawable("assets/CrimsonRacing/CrimsonRacinggreenscreen.mp4", .95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
		...
		var playButtonImgCrimsonRacing = new AR.ImageResource("assets/CrimsonRacing/CrimsonRacingvidStill.png");
        ...
        //EcoCar STUFF
{
        var EcoCarVideo = new AR.VideoDrawable("assets/EcoCar/EcoCargreenscreen.mp4", .95, {
			offsetX: -0.15,
			offsetY: +0.25,
			isTransparent: true,
			zOrder: 1,
